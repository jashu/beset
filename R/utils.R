...
#' that this argument can be passed as a "quoted" string, which requires the
#' removal of the line `link <- substitute(link)`. This in turn enables the
#' removal of `do.call` syntax. All other edits are to define the namespaces of
#' of other MASS functions that are called by `glm.nb`.
