...
1. **Mean absolute error.** This corresponds to the mean of the absolute value of the prediction residuals. On average, our model predictions tend to miss the true PSA score by `r round(cv_results$stats$mae$mean, 2)` log units. 
